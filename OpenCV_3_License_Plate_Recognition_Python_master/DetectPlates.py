...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            pt1 = tuple(p2fRectPoints[0])
            pt2 = tuple(p2fRectPoints[1])
            pt3 = tuple(p2fRectPoints[2])
            pt4 = tuple(p2fRectPoints[3])
            cv2.line(imgContours, pt1, pt2, (0,0,255), 2)
            cv2.line(imgContours, pt2, pt3, (0,0,255), 2)
            cv2.line(imgContours, pt3, pt4, (0,0,255), 2)
            cv2.line(imgContours, pt4, pt1, (0,0,255), 2)
